							...
							<ul class="navbar-nav ml-auto">
								...
								<li class="nav-item dropdown no-arrow mx-1">
									...
									<div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
										...
										<div style="text-align:center;"><?php  echo '<b>Cantidad Presentes :  '  .  $fila['presentes'].'</b>'; ?></div>
										<br>
										<div style="text-align:center;"><?php  echo '<b>Cantidad Ausentes :  '  .  $cantidad['ausentes'].'</b>'; ?></div>
									</div>
								</li>
								<b></b>
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
						   <tbody style="text-align: center;">
                                <tr class="bg-success">
                                  ...
                                  <td> <input type="varchar" required name="cuil" id="cuil" placeholder="CUIL..."></td>
