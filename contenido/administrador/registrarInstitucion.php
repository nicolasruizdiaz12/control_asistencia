        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <?php
                    include 'datos_institucion/conexion.php';
                    if (isset($_POST['submit'])) {
                        if (is_uploaded_file($_FILES['fichero']['tmp_name'])) {
                            ...
                            if (move_uploaded_file($_FILES['fichero']['tmp_name'], $upload)) { //movemos el archivo a su ubicacion 
                                ...
                                $query = "INSERT INTO institucion_dato (nombre_institucion,direccion_institucion,cuid_institucion,telefono_institucion,ruta,tipo) 
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;">Registrar Datos</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <tbody style="text-align: center;">
                                            <tr class="bg-success">
                                                <td style="color:#FFFFFF">Nombre Institución</td>
                                                <td style="color:#FFFFFF">DIRECCIÓN</td>
                                                <td style="color:#FFFFFF">CUID</td>
                                                <td style="color:#FFFFFF">TELEFONO</td>
                                                <td style="color:#FFFFFF">LOGO</td>
                                            </tr>
                                            <td><input type="text" required name="nombre" id="nombre" placeholder="Nombre..." value="" /> </td>
                                            <td> <input type="varchar" required name="direccion" id="direccion" placeholder="Dirección..."></td>
                                            <td><input type="varchar" required name="cuid" id="cuid" placeholder="Cuid..." value="" /> </td>
                                            <td><input type="varchar" required name="telefono" id="telefono" placeholder="Telefono..." value="" /></td>
                                            <td><input name="fichero" type="file" size="150" maxlength="150"></td>

                                        </tbody>
                                    </table>
                                    <br>
                                    <center><input class="btn-primary align-items-center" name="submit" type="submit" id="guardarDatos" value="Guardar"></center>
                                </form>
                            </div>
                        </div>
                    </div>
