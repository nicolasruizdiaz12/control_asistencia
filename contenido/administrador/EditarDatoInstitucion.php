					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<div class="table-responsive">
								...
								$query = "SELECT * FROM institucion_dato WHERE id_institucion_dato='id_institucion_dato'";
								$resultado = $conexion->query($query);
								$row = $resultado->fetch_assoc();
								?>
								<form action="datos_institucion/editar.php?id_institucion_dato=<?php echo $row['id_institucion_dato'] ?>" method="POST">
									...
									<br>
									<center><input class="btn-primary" name="submit" type="submit" value="Guardar Edición"></center>
								</form>
							</div>
						</div>
					</div>
