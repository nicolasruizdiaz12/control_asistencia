                                ...
                                <form action="materias/guardarMateria.php" method="POST" id="frmRegistro">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <tbody style="text-align: center;">
                                            <tr class="bg-success">
                                                <td style="color:#FFFFFF">Materia</td>
                                                <td style="color:#FFFFFF">Profesor</td>
                                            </tr>
                                            <tr>
                                            <td><input type="text" required name="nombreMateria" id="nombreMateria" placeholder=" Nombre..." value="" /> </td>
                                            <td><input type="text" required name="nombreProfe" id="nombreProfe" placeholder=" Apellido y Nombre..." value="" /> </td>
                                            </tr>
                                            <tr>
                                            <td><input type="text" required name="id_carrera" id="id_carrera" placeholder=" Asignatura..." value="" /> </td>
                                            <td> <input type="varchar" required name="cuilProfe" id="cuilProfe" placeholder=" CUIL..."></td>
                                            </tr>
