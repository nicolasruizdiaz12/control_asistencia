                                    ...
                                    if (isset($_POST['submit'])) {
                                        if (is_uploaded_file($_FILES['fichero']['tmp_name'])) {
                                            ...
                                            if (move_uploaded_file($_FILES['fichero']['tmp_name'], $upload)) { //movemos el archivo a su ubicacion
                                                ...
                                                $query = "INSERT INTO horario (description,ruta,tipo,id_carrerar, id_periodo) 
                                                VALUES ('$description','" . $nombrefinal . "','" . $_FILES['fichero']['type'] . "','" . $_FILES['fichero']['size'] . "','$id_usuario')";
