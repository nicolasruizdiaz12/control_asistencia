                                    ...
                                    if (isset($_POST['submit'])) {
                                        if (is_uploaded_file($_FILES['fichero']['tmp_name'])) {
                                            ...
                                            if (move_uploaded_file($_FILES['fichero']['tmp_name'], $upload)) { //movemos el archivo a su ubicacion 
                                                ...
                                                $query1 = "INSERT INTO notificacione (description,fecha_noti,ruta,tipo,id_vista,id_usuario)
                                                VALUES ('$description','$fechahoy','" . $nombrefinal . "','" . $_FILES['fichero']['type'] . "','2','$id_usuario')";
