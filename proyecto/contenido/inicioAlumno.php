	...
	<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
	  ...
	  <ul class="navbar-nav ml-auto">
        ...
        <div class="container-fluid" id="fondo">
          ...
          <h1 class="h3 mb-4 text-success-800"><span class="parpadea text"><strong>Especialización Técnica en Desarrollo de Software</strong></h1>

          <!-- Page Heading -->
          <div class="boton"><a href="#">PRESENTE</a></div>
