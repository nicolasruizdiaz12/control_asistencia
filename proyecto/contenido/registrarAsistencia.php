<?php
    ...
    if (mysqli_num_rows($consulta) > 0) {
        ...
        $query1="INSERT INTO registro(asistencia, fecha, id_usuario) VALUES('$presente','$fechahoy','$id_usuario')",
        $resultado= $conexion->query($query1),JSON_FORCE_OBJECT);

    } else {
        echo json_encode(array('estado' => 'error', 'mac' => $macRed, 'nombre' => $nombre),
        $query2="INSERT INTO registro(asistencia, fecha, id_usuario) VALUES('$ausente','$fechahoy','$id_usuario')",
